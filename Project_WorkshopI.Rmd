...
ggplot(df_factor, aes(x = children, y = charges, fill = sex)) +
  geom_boxplot(position = "dodge", color = "black") +
  scale_fill_manual(values = c("pink", "skyblue")) +
  labs(x = "Children", y = "Charges", fill = "Sex")

ggplot(df_factor, aes(x = smoker, y = charges, fill = sex)) +
  geom_boxplot(position = "dodge", color = "black") +
  scale_fill_manual(values = c("pink", "skyblue")) +
  labs(x = "Smoker", y = "Charges", fill = "Sex")

ggplot(df_factor, aes(x = region, y = charges, fill = sex)) +
  geom_boxplot(position = "dodge", color = "black") +
  scale_fill_manual(values = c("pink", "skyblue")) +
  labs(x = "region", y = "Charges", fill = "Sex")
```
...
coef_lasso <- coef(lasso_mdl, s = 'lambda.min')  # lambda.min selects the value that minimizes the cross-validated error
print(coef_lasso)
```
```{r}
# Calculate residuals
...
predictions_lasso <- predict(lasso_mdl, s = 'lambda.min', newx = as.matrix(test_data_scaled[,-ncol(test_data_scaled)]), type = "response")
